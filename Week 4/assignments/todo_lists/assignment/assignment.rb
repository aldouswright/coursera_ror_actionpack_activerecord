...
class Assignment
  ...
  def find_allusers(offset, limit)
      ...
      concise_ulist = User.all.offset(offset).limit(limit)
      return concise_ulist
  end
  ...
  def find_alllists(offset, limit)
      ...
      concise_tdllist = TodoList.all.order(list_due_date: :desc).offset(offset).limit(limit)
      return concise_tdllist
  end
